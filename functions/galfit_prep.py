...
master = ascii.read('/disk2/turner/disk1/turner/DATA/all_names_new.txt')
names = ascii.read('/disk2/turner/disk1/turner/Catalogues/goods_s/just_names.txt')
...
for f, r, n in zip(master['Filename'], master['redshift'], names['name']):
    ...
    galfit_input(f,
                 r,
                 n,
                 '/disk2/turner/disk1/turner/DATA/Victoria_galfit/n_band_outputs_flatfield/')